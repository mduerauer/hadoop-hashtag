 ...
 */
public class UserTweetCount2 extends Configured implements Tool {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserTweetCount2.class);

    private static final int TOP_N = 50;

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new UserTweetCount2(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job1.setMapperClass(UserTweetCount2.Map.class);
        job1.setReducerClass(UserTweetCount2.Reduce.class);
        ...
        job2.setMapperClass(UserTweetCount2.TopNMap.class);
        job2.setReducerClass(UserTweetCount2.TopNReduce.class);
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable offset, Text lineText, Context context)
            ...
            if(user != null && !user.isEmpty()) {
                context.write(new Text(user.replace("http://twitter.com/","")), one);
            }
        }
    }
